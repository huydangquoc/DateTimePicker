...
@objc public class DateTimePicker: UIView {
  ...
  private func configureView() {
    ...
    layout.itemSize = CGSize(width: 48, height: 90)
    
    dayCollectionView = UICollectionView(frame: CGRect(x: 20, y: 44, width: contentView.frame.width - 40, height: 100), collectionViewLayout: layout)
